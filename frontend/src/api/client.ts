...
export const api = {
  ...
  approveAndActivateAccessRequest(token: string, requestId: string, body: AccessRequestReviewPayload) {
    return request<AccessRequest>(`/api/v1/access-requests/${requestId}/approve-and-activate`, {
      method: 'POST',
      token,
      body,
    })
