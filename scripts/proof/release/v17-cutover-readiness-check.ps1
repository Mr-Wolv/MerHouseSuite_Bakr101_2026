...
$artifactPaths = [ordered]@{
    ...
    androidReleaseArtifact = Join-Path $resolvedOutputDirectory "v17-cutover-check-app-release.apk"
    invalidAndroidReleaseArtifact = Join-Path $resolvedOutputDirectory "v17-cutover-check-invalid-app-release.apk"
...
try {
    ...
    if (
        ...
        $_.Exception.Message -match "outputFiles.loadSmoke result.averageMs" -and
        $_.Exception.Message -match "outputFiles.loadSmoke result.maxMs" -and
