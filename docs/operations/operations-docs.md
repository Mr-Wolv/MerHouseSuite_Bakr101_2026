...
Current V17 direction is Neon PostgreSQL, Hugging Face Docker Space backend, Vercel frontend, and GitHub Release APK distribution. VPS/Compose, Cloud Run, Oracle Cloud Always Free, and sponsored hosting are VInfinite candidates unless the roadmap deliberately reopens them.
