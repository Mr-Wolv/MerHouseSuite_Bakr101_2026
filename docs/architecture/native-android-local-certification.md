...
| `scripts/quality/native-mobile-check.ps1` | Structural, sync, and APK assembly proof |
| `scripts/quality/native-android-tour.ps1` | Installed-APK route tour and screenshot proof |
...
- installed-APK route records have exact normalized web/native route-set equality and valid PNG screenshot evidence through `.\scripts\quality\cross-surface-tour-check.ps1`
