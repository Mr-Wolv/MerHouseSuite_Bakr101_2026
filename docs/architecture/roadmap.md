...
- feature changes: add or update focused tests for the newly added behavior, including unit/component coverage where practical, and revise existing tests so they check the current invariant rather than stale fixture details
